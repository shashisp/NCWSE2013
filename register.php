...
$query="INSERT INTO authors(name, college, email, password) values ('$name', '$college','$email','$password')";
...
<html lang="en">
  ...
  <a class="btn btn-success" href="login.php">login now!</a>
